...
namespace Trabajo_Final
{
    public partial class EditarPerfilDocente : Form
    {
        ...
        private void CargarDatos()
        {
            ...
            textBox2.Text = usuario.Gmail;
            textBox3.Text = usuario.Password;
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            var original = usuarios.FirstOrDefault(x => x.Gmail == usuario.Gmail);
        ...
        private void EditarPerfilDocente_Load(object sender, EventArgs e)
        {
